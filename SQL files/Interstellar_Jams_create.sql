...
CREATE TABLE `gamematch` (
  ...
  `match_state_id` bigint NOT NULL DEFAULT '0',
  `match_map_id` bigint NOT NULL DEFAULT '1',
...
CREATE TABLE `player` (
  ...
  `player_wins` bigint DEFAULT '0',
  `player_matches` bigint DEFAULT '0',
...
CREATE TABLE `playermatch` (
  `player_id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `playermatch_match_id` bigint NOT NULL,
  `tile_id` bigint NOT NULL,
  `player_cassette_id` bigint NOT NULL DEFAULT '0',
  `player_hazard_duration` bigint NOT NULL DEFAULT '0',
  `has_moved` tinyint(1) NOT NULL DEFAULT '0',
  `has_used_a_cassette` tinyint(1) NOT NULL DEFAULT '0',
  `random_cassettes_optained` tinyint(1) NOT NULL DEFAULT '0',
  `is_stoped` tinyint(1) NOT NULL DEFAULT '0',
  `cassettes_broken` tinyint(1) NOT NULL DEFAULT '0',
  `player_match_idle_turns` varchar(45) DEFAULT NULL,
  `second_player` varchar(45) NOT NULL DEFAULT '0',
  PRIMARY KEY (`player_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `playermatchcassette` (
  ...
  PRIMARY KEY (`player_cassette_id`,`player_id`)
...
-- Dump completed on 2024-06-10 23:47:56
